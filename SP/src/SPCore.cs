...
namespace Diacom
{
	...
	public interface ISP : IDisposable
	{
		...
		object this [object lineID, object key]{get; set;}
	...
	namespace Cmd
	{
		...
		public class RejectCall : CmdBase
		{
			...
			public RejectCall(object sender, object line, int rejectCode)
		...
		public class PassCall : CmdBase
		{
			...
			public PassCall(object sender, object line) 
				: base(CommandID.PASS_CALL, sender, line) 
			{
			}
		}
		...
		public class DropCall : CmdBase
		{
			...
			public DropCall(object sender, object line)
				: base(CommandID.DROP_CALL, sender, line) 
			{
			}
		}
		...
		public class Connect : CmdBase
		{
			...
			public Connect(object sender, object line1, object line2)
				 : base(CommandID.CONNECT_LINES, sender, line1) 
			{
				LineOne = line1;
				LineTwo = line2;
			}
		...
		public class Disconnect : CmdBase
		{
			...
			public Disconnect(object sender, object line)
				 : base(CommandID.DISCONNECT_LINE, sender, line) 
			{
			}
		}
		...
		public class RecordFile : CmdBase
		{
			...
			public RecordFile(object sender, object line, string filePath, string cutOffString, int appendMode)
				: base(CommandID.RECORD_FILE, sender, line) 
			{
				this.FilePath = filePath;
				this.CutOffString = cutOffString;
	...
	namespace Ev
	{
		...
		/// </summary>
		public class LineLinked : EvBase
		{
			/// <summary>
			/// Initializes new instance of class with specified line number.
			/// </summary>
			...
			public LineLinked(object line, object linkedLine) : base(line, Ev.EventID.LINK_LINE)
			{
				this.SlaveLine = linkedLine;
			}

			/// <summary>
			/// State of the line.
			/// </summary>
			public readonly object SlaveLine;
		}
	...
	public class TraceOut
	{
		...
		private static WaitingQueue<String> MessagesQueue = new WaitingQueue<String>();
		...
		private static void TraceWriter()
		{
			while(true)
			{
				...
				{
					System.Diagnostics.Trace.WriteLine("[TraceWriter] Thread is terminating...");
					return;
				}
		...
		static TraceOut()
		{
			...
			TraceWriterHandle.Name = "TraceWriter";
		...
		{
			MessagesQueue.Enqueue( "[" + System.Threading.Thread.CurrentThread.Name + "][" + System.DateTime.Now.ToString("HH:mm:ss:fff") + "]: " + aMessage );
		}
	...
	public class  WaitingQueue<T>
	{
		...
		/// </summary>
		private System.Threading.ManualResetEvent queueHasData = new System.Threading.ManualResetEvent(false);

		/// <summary>
		/// The queue itself.
		/// </summary>
		private System.Collections.Generic.Queue<T> dataQueue = new System.Collections.Generic.Queue<T>();

	...
	namespace AltiGen
	{
		...
		internal class AltiLinkPlus
		{
			...
			internal class ALPDataBlock : ALPData, IEnumerable, IEnumerator
			{
				...
				/// </summary>
				private ArrayList paramArray = new ArrayList();
				...
				/// <summary>
				/// Implements the <see cref="IEnumerable"/> interface for simple parameters iteration.
				/// </summary>
				/// <returns>A class that implements <see cref="IEnumerator"/> interface.</returns>
				...
				/// <summary>
				/// <para>Implements the <see cref="IEnumerator.Reset"/> interface for simple iteration.</para>
				/// <para>Gets current element.</para>
				/// </summary>
				...
				/// <summary>
				/// <para>Implements the <see cref="IEnumerator.Reset"/> interface for simple iteration.</para>
				/// <para>Moves to next element in enumeration.</para>
				/// </summary>
				/// <returns>Next element in enumeration.</returns>
